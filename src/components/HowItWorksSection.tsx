...
const ShareStoryIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    ...
    />
    <path
      d="M24 16 L18 24 L30 24 L24 32 L24 16"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const HowItWorksSection: React.FC = () => {
  ...
  return (
    <section
      ref={ref}
      className="pt-16 sm:pt-20 lg:pt-24 pb-24 sm:pb-28 lg:pb-48 relative overflow-hidden bg-gradient-to-b from-background via-muted/20 to-background"
    >
                ...
                >
                  ...
                  <div className="flex flex-col items-center mb-6">
                    <div className="relative">
                      ...
                      <div className="w-16 h-16 sm:w-24 sm:h-24 bg-gradient-teal rounded-full flex items-center justify-center shadow-elegant group-hover:shadow-teal transition-shadow duration-700">
                  ...
                  <div className="bg-warm-white border border-border/40 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-soft hover:shadow-elegant hover:border-saffron/30 transition-all duration-700 h-fit relative overflow-hidden">
