        ...
        <div className="flex items-center justify-between h-20">
          ...
          >
            <PremiumButton
              ...
              icon={<BsChevronRight className="transition-transform duration-300 group-hover:translate-x-1" />}
              onClick={() => handleNavClick("#services")}
              className="relative overflow-hidden group transform transition-all duration-300 hover:scale-105 hover:shadow-saffron-glow/30"
            />
          </motion.div>
          ...
          <motion.button
            ...
            className="md:hidden p-3 rounded-xl bg-gradient-to-r from-saffron/10 to-teal/10 hover:from-saffron/20 hover:to-teal/20 transition-all duration-300"
          >
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            <motion.div
              ...
              className="md:hidden border-t border-border/30 overflow-hidden bg-gradient-to-b from-warm-white/95 to-warm-white/98 backdrop-blur-xl"
            >
